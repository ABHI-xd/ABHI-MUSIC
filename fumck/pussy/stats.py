...
from fumck.lumd.DB.gban import get_gbans_count
from fumck.lumd.DB.chats import get_served_chats
from fumck.lumd.DB.sudo import (get_sudoers, get_sudoers, remove_sudo)
from fumck.lumd.DB.playlist import get_playlist_count
from fumck.lumd.helpers.time import get_readable_time
from fumck import app, SUDOERS, Music_START_TIME
import os 
import time
from pymongo import MongoClient
from fumck.config import MONGO_DB_URI as smex
...
async def gstats(_, message):
    ...
    free = str(free)
    msg = f"""
**Global Stats of **__SNEHABHI__** Bot**:\n\n
