...
from fumck import app, SUDOERS, BOT_ID, BOT_USERNAME, OWNER
from fumck import dbb, app, BOT_USERNAME, BOT_ID, ASSID, ASSNAME, ASSUSERNAME
from fumck.lumd.helpers.inline import start_keyboard, personal_markup
from fumck.lumd.helpers.thumbnails import down_thumb
from fumck.lumd.helpers.ytdl import ytdl_opts 
...
pstart_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📢 Uᴘᴅᴀᴛᴇꜱ 📢", url=f"https://t.me/vexera_updates"), 
                    InlineKeyboardButton(
                        "💬 Sᴜᴘᴘᴏʀᴛ 💬", url=f"https://t.me/snehabhi_server")
                ],
                [ InlineKeyboardButton("🧑‍💻 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ 🧑‍💻", url=f"https://t.me/vexera_updates"),]
